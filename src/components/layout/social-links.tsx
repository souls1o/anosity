...
const linkClass =
  "inline-flex h-10 w-10 items-center justify-center rounded-lg border border-slate-700/80 bg-slate-900/40 text-slate-400 transition-colors hover:border-cyan-500/40 hover:bg-slate-800/80 hover:text-cyan-200";
